...
public final class ImageTools {
     ...
     * @param format the final image format. Can be "jpg", "png", "gif", "bmp",
     *               "wbmp".
     * @return
     * @throws IOException
     */
     ...
     *
     * @param originalImage
     * @param scaledWidth   width in pixels.
     * @param scaledHeigh   height in pixels.
     * @return
     */
     ...
     * @param scaledWidth   width in pixels.
     * @param scaledHeigh   height in pixels.
     * @param preserveAlpha preserve alpha channel.
     * @return
     */
    public static BufferedImage resizeImage(BufferedImage originalImage, int scaledWidth, int scaledHeigh,
